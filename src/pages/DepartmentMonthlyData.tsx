...
export default function DepartmentMonthlyData() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-muted-foreground">이연 매출 / 매입은 1월 데이터에만 기입하며, 전년도에서 이연된 매출/매입을 뜻합니다.</div>
      <div className="text-xs text-muted-foreground">*2026년까지는 기입하지 않습니다.</div>
