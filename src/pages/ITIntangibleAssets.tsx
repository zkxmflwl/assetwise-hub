    ...
    <div className="space-y-4">
      ...
      {canEdit && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={downloadIntangibleTemplate} className="flex items-center gap-1.5 rounded-lg border border-border bg-secondary/50 px-3 py-2 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors">
